...
const PayslipComponent: React.FC = () => {
    ...
    const fetchRequests = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                'http://127.0.0.1:8000/api/payroll-slip',
                { email: session?.user?.email, tanggal: new Date() },
                {
            ...
            // console.log()
            handleAxiosError(error, 'slip gaji');
            setTimeout(() => {
                router.push('/');
            }, 5000);
        } finally {
            ...
            <div ref={componentRef} className="surface-card p-6 shadow-2 border-round print-section">
                ...
                <table className="table-print w-full mb-6">
                    ...
                    <tbody>
                        ...
                        <tr className="surface-0 font-semibold">
                            <td>Gaji Bersih</td>
